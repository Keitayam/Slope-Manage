...
<section id="fv" class="fv">
    <div class="wrap">
        <div class="fv__title__box">
            ...
            <p class="text eb">Your trusted private banker, <br>
                leading you to an unreachable future on your own.</p>
        </div>
    </div>
                        ...
                        <li class="splide__slide item">
                            <div class="link">
                                <div class="heading">
                                    <p class="num eb">01</p>
                                    <div class="info">
                                        <p class="text">50代 開業医の場合</p>
                                        <ul class="tags">
                                            <li class="tag">50代</li>
                                            <li class="tag">AI SLOPE</li>
                                            <li class="tag">不動産投資</li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="text__box">
                                    <p class="text sh">ポートフォリオのバランスを調整し<br>目標利回りの達成確率の維持が可能に</p>
                                </div>
